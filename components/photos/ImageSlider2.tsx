...
const ImageSlider2 = ({
  images, index, onClose, imagesBlurs,
}: Props) => {
    ...
    <div className="relative h-screen flex flex-col justify-center items-center">
      ...
      >
        <Image
          ...
          placeholder="blur"
          blurDataURL={imagesBlurs[currentIndex]}
      ...
      <div className="hidden md:flex center max-w-[90%] fixed bottom-12 flex-wrap justify-center align-center">
        {images.map((_, i) => (
          <div
            ...
            onClick={() => goToSlide(i)}
            className={
              currentIndex === i ? 'indicator' : 'indicator indicator-inactive'
            }
          />
        ))}
      </div>
      <p className="flex md:hidden ml-3 text-white text-2xl absolute bottom-8 left-1">
        {currentIndex + 1}
        /
        {totalImages}
      </p>
